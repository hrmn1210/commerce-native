                    ...
                    <div id="offline_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-bordered dataTable no-footer" id="offline" role="grid"
                                    aria-describedby="offline_info" style="width: 100%;" width="100%" cellspacing="0">
                                    <thead>
                                        <tr class="text-center" role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="offline" rowspan="1"
                                                ...
                                                aria-label="NIK: activate to sort column ascending">Total
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="offline" rowspan="1"
                                                colspan="1" style="width: 166px;"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="index.php?halaman=detail&id=<?= $pembelian["id_pembelian"]; ?>"
                                                    class="btn-info btn mt-2">Detail</a>
                                                <?php if ($pembelian['status_pembelian'] != "Pending") : ?>
                                                <a href="index.php?halaman=pembayaran&id=<?= $pembelian['id_pembelian']; ?>"
                                                    class="btn-success btn mt-2">Lihat Pembayaran</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="offline_info" role="status" aria-live="polite">Showing
                                    0 to 0 of 0 entries</div>
                            </div>
                            <div class="col-sm-12 col-md-7">
                                <div class="dataTables_paginate paging_simple_numbers" id="offline_paginate">
                                    <ul class="pagination">
                                        <li class="paginate_button page-item previous disabled" id="offline_previous"><a
                                                href="#" aria-controls="offline" data-dt-idx="0" tabindex="0"
                                                class="page-link">Previous</a></li>
                                        <li class="paginate_button page-item next disabled" id="offline_next"><a
                                                href="#" aria-controls="offline" data-dt-idx="1" tabindex="0"
