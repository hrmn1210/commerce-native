...
<body>
    ...
    <div class="container-fluid">
        <h1 class="mt-4">Hai <?= $_SESSION['loginAdmin']['Nama'];?></h1>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-danger text-white mb-4">
                    <div class="card-body"> <i class="fas fa-clock"></i> Dalam Proses (pending)</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link"
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="card bg-success text-white mb-4">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="index.php?halaman=pembelian">
                            <?= $lunas['lunas'];?></a>
                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                    </div>
                </div>
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Profil Admin Yang Sedang Login</li>
        </ol>
        <div class="card-body">
            <form method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control-plaintext" name="alamat" id="inputAlamat" rows="2"
                            ...
                            required="required"><?= $_SESSION['loginAdmin']['alamat_admin'];?></textarea>
                    </div>
                </div>
            </form>
        </div>
