                                ...
                                <table class="table table-bordered dataTable no-footer" id="offline" role="grid"
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td>
                                                <a href="index.php?halaman=hapus&id=<?= $produk['id_produk']; ?>"
                                                    class="btn-danger btn mt-2" onclick="return confirm('Yakin?');"><i
                                                        class="fa fa-trash"></i></a>
                                                <a href="index.php?halaman=ubah&id=<?= $produk['id_produk']; ?>"
                                                    class="btn-info btn mt-2"><i class="fa fa-edit"></i></a>
                                            </td>
                                        </tr>
                                        <?php $nomor++; ?>
                                        <?php endforeach; ?>
