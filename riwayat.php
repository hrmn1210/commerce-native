...
<head>
    ...
    <title>Toko Ajan - Riwayat Belanja</title>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-4">
                            <a href="nota.php?id=<?= $barang["id_pembelian"]; ?>"
                                class="btn btn-info col-3 mr-2">Nota</a>
                            <?php if ($barang['status_pembelian'] == "Pending") : ?>
                            <a href="pembayaran.php?id=<?= $barang["id_pembelian"]; ?>"
                                class="btn btn-success col-7">Konfirmasi Pembayaran</a>
                            <?php else : ?>
                            <a href="lihat_pembayaran.php?id=<?= $barang["id_pembelian"]; ?>"
