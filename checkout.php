...
<head>
    ...
    <title>Toko Ajan - Checkout</title>
                        ...
                        <div id="offline_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telepon" id="telepon" class="form-control"
                                            value="0<?= $_SESSION['loginPelanggan']['no_hp'] ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10 col-lg-12">
                                    <button class="btn btn-info w-100" type="submit" name="bayar">Bayar
                                        Sekarang</button>
