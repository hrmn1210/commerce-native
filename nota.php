...
<head>
    ...
    <title>Toko Ajan - Detail Pembelian</title>
...
<body>
    <div class="container-fluid">
        <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background-color: white;">
            <div class="container"><img src="assets/img/ajan.jpeg" style="width: 100px;"><a class="navbar-brand"
                    href="#" style="font-size: 23px;"></a><button data-toggle="collapse" class="navbar-toggler"
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    <span class="navbar-text actions">
                        ...
                        <span class="navbar-text actions">
                            ...
                            <a class="btn btn-light action-button w-5 p-2" role="button"
                                style="background-color: maroon; color:white;" href="index.php">Home</a>
                            <a class="btn btn-light action-button w-5 p-2" role="button"
                                style="background-color: maroon; color:white;" href="riwayat.php ">Riwayat</a>
                            <?php endif ?>
                        </span>
                    </span>
                </div>
                ...
                <form action="" method="post">
                    <div class="table-responsive">
                        <div id="offline_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table table-bordered dataTable no-footer" id="offline" role="grid"
                                        aria-describedby="offline_info" style="width: 100%;" width="100%"
                                        cellspacing="0">
                                        <thead>
                                            <tr class="text-center" role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="offline" rowspan="1"
                                                    colspan="1" style="width: 99px;" aria-sort="ascending"
                                                    aria-label="No: activate to sort column descending">No.
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="offline" rowspan="1"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td><img src="admin/dist/assets/img/<?= $barang["foto_produk"]; ?> "
                                                        width="50%"></td>
                                                <td><?= $barang["nama"]; ?></td>
                                                <td><?= substr($barang['deskripsi'], 0, 100), ""; ?><a
                                                        href="#">(Selengkapnya..)</a></td>
                                                <td class="text-center text-justify">Rp
                                                    <?= number_format($barang['harga_produk'], 0, ",", "."); ?></td>
                                                <td class="text-center text-justify"><?= $barang['jumlah']; ?></td>
                                                <td class="text-center text-justify">Rp
                                                    <?= number_format($barang['sub_harga'], 0, ",", "."); ?></td>
                                            </tr>
                                            <?php $nomor++;
                                                $totalHarga += $harga;
                                                ?>
                                        ...
                                        <tfoot class="table-responsive-md table-responsive-sm table-info">
                                            <tr class="odd" style="background-color: maroon; color:white;">
                                                <th colspan="6">Total Harga : </th>
                                                <th class="text-center" colspan="6">Rp
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" id="nama" class="form-control"
                                            value="<?= $_SESSION['loginPelanggan']['Nama'] ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telepon" id="telepon" class="form-control"
                                            value="<?= $_SESSION['loginPelanggan']['no_hp'] ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" id="email" class="form-control"
                                            value="<?= $_SESSION['loginPelanggan']['email'] ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" id="nama" class="form-control"
                                            placeholder="alamat" value="<?= $_SESSION['loginPelanggan']['alamat'] ?>"
                                            readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group alert alert-info w-auto">
                                        <p class="w-100" style="font-size: medium;">
                                            ...
                                            <?= number_format($totalHarga, 0, ",", "."); ?> ke
                                            <!-- <br> -->
                                            <strong>BANK BRI 4199-0101-0791-531 AN. Toko Ajan</strong>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group text-center">
                                        <a href="pembayaran.php?id=<?= $_GET['id']; ?>" class="btn btn-outline-primary"
                                            type="button" name="bayar"><Strong><i>Konfirmasi Pembayaran</i></Strong></a>
                                    </div>
                                </div>
                            </div>
                        </div>
